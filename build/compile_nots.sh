...
icpc -c -O2 -std=c++20 ../src/model_and_calculation_helper.cpp
icpc -c -O2 -std=c++20 ../src/VariationalMonteCarlo.cpp
icpc -c -O2 -std=c++20 ../src/main.cpp
icpc -O2 -L$LD_LIBRARY_PATH -I$CPATH -lgsl -lgslcblas -lmkl -liomp5 -lpthread vmctype.o vmc_io.o Lattice.o MeanFieldAnsatz.o Wavefunction.o ProjectedState.o vmc_numerical.o model_and_calculation_helper.o VariationalMonteCarlo.o main.o -o ../bin/vmc++.exe
